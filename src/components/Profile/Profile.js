    ...
    <ProfileWrapperRow>
      ...
      <ProfileWrapperColumn>
        <TextWrapper>
          ...
          <Subtitle>
            Crafted in React and Ruby on Rails, Agile, and Test-Driven Development methods with a mobile first approach
            to software development. In the last 2 years i have taken the time and resources to finisse my skills. And i
            have gained a deeper understand of building, architecting and scaling web and mobile apps.
          </Subtitle>
          <Subtitle />
        </TextWrapper>
      </ProfileWrapperColumn>
