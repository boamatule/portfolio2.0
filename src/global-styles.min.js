import{normalize}from"normalize.css";import styled,{createGlobalStyle}from"styled-components/macro";export const GlobalStyles=createGlobalStyle`
  ${normalize}
:root {
  --light: grey;
  --dark: grey;
...
`;export const Button=styled.button`
  white-space: nowrap;
  padding: ${({big:big})=>big?"12px 4px":"10px 20px"};
  color: grey;
  font-size: ${({fontBig:fontBig})=>fontBig?"20px":"16px"};
  outline: none;
  cursor: pointer;
  background: #4568dc;
  ...
  &:hover {
    ...
    background: ${({primary:primary})=>"purple"};
    color: grey;
    text-decoration: none;
  }
